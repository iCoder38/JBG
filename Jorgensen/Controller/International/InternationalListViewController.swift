//
//  InternationalListViewController.swift
//  Jorgensen
//
...
class InternationalListViewController: BaseViewController {

    var arrTitle = NSMutableArray()
       var sipagingEnable = true
       var dictevent = Dictionary<String , Any>()
      let cellReuseIdentifier = "internationalTableCell"
    ...
    @IBOutlet weak var iconImageview:UIImageView! {
       ...
       @IBOutlet weak var lblNavigationTitle:UILabel! {
           didSet {
               lblNavigationTitle.text = "INTERNATIONAL"
       ...
       func loadMessages()
         {
           IHProgressHUD.show(withStatus: "Please wait...")
             ...
             let body = "id_language=en-US&id_module=m301,m305,m300,m303,m302,m306,m304&token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZF9lYXAiOiIxNjUxIiwiaWRfY29tcGFueSI6MTY1MTI2NTY3fQ.FznzxAPBbFF9kI2Vd6G39P6kO431dztk8TN9VYir-jY&api_id=1651"
...
extension InternationalListViewController: UITableViewDataSource {
...
extension InternationalListViewController: UITableViewDelegate {
