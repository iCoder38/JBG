//
//  ThrivingListViewController.swift
//  Jorgensen
//
...
class ThrivingListViewController: BaseViewController {
    
    
    var arrTitle = NSMutableArray()
    var sipagingEnable = true
    var dictevent = Dictionary<String , Any>()
    let cellReuseIdentifier = "thrivingTableCell"
    ...
    @IBOutlet weak var lblNavigationTitle:UILabel! {
        didSet {
            lblNavigationTitle.text = "TRIVING"
    ...
    func loadMessages()
    {
     IHProgressHUD.show(withStatus: "Please wait...")
        ...
        let body = "id_language=en-US&id_module=m029,m028,m033,m025,m027,m024,m026,m031,m032,m030&token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZF9lYXAiOiIxNjUxIiwiaWRfY29tcGFueSI6MTY1MTI2NTY3fQ.FznzxAPBbFF9kI2Vd6G39P6kO431dztk8TN9VYir-jY&api_id=1651"
...
extension ThrivingListViewController: UITableViewDataSource {
...
extension ThrivingListViewController: UITableViewDelegate {
